        ...
        <div className="max-w-4xl mx-auto">
          {projects.map((project) => (
            <motion.div
              ...
              className={cn(
                "group relative rounded-3xl overflow-hidden cursor-pointer bg-zinc-900 border border-white/5",
              ...
              <div className="p-8 md:p-10 relative">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 text-sm font-medium text-zinc-500 bg-black/20 border border-white/5 rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            <motion.div
              ...
              className="relative w-full max-w-4xl bg-zinc-900 rounded-3xl overflow-hidden border border-white/10 z-10 flex flex-col max-h-[90vh] will-change-transform"
